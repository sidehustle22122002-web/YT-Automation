...
Topic: {topic}
EXACT REQUIREMENT: full_script must be between 150-180 words total.
...
- fact1: Dark fact (25-30 words).
- fact2: Darker fact (25-30 words).
- fact3: Hidden truth (25-30 words).
- story: Shocking narrative (30-40 words).
